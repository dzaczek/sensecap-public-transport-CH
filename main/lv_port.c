...
void lv_port_init(void)
{
    ...
    // Increase stack size to 8KB (8192) or even 16KB to prevent overflow during complex UI updates
    xTaskCreate(lvgl_task, "lvgl_task", 32 * 1024, NULL, CONFIG_LCD_TASK_PRIORITY, &lvgl_task_handle);
}
